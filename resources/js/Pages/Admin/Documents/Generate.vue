            ...
            <div class="quick-certificate__grid">
                <div :class="['quick-certificate__data', { 'mobile-hidden': mobileTab !== 'data' }]">
                    ...
                    <div v-if="analysis" class="panel extraction-summary">
                        ...
                        <label v-if="canIssue && quickBilling" class="quick-billing-option"><input v-model="form.quick_invoice" type="checkbox"><span><strong>FACTURA</strong><small>{{ quickBilling.service }} · {{ quickBilling.quantity }} × {{ money(quickBilling.unit_price) }} · {{ quickBilling.tax_category }} · {{ quickBilling.payment_method }} · Se crea como borrador y no consume NCF</small></span></label>
